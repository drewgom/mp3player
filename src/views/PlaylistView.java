...
public class PlaylistView extends PlayerView {
    ...
    static private PlaylistView playerView;
    ...
    public static PlaylistView getPlayerView()	{
        if (playerView == null)	{
            playerView = new PlaylistView();
        }
    ...
    private PlaylistView()	{
        ...
        mainWindow.getContentPane().add(Interface, BorderLayout.CENTER);
